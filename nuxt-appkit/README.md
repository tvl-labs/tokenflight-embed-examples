# TokenFlight Receive - Nuxt + AppKit

A standalone example demonstrating intent-based trading using [TokenFlight Receive](https://tokenflight.xyz), [Nuxt 4](https://nuxt.com), and [Reown AppKit](https://reown.com/appkit).
...
4. **Home Page** (`pages/index.vue`) -- Renders the `Receive` component inside a centered container.
