...
This file handles dynamic import of `@tokenflight/swap/widget`, wallet adapter setup via `@tokenflight/adapter-appkit`, and rendering the `<tokenflight-widget>` web component (configured as EXACT_OUTPUT receive flow). Start here to understand how TokenFlight is wired into the app.
