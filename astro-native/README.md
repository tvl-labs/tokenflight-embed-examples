# TokenFlight Receive -- Astro + Native JS

The simplest possible TokenFlight Receive integration. No framework islands required -- just vanilla JavaScript in an Astro static site.
...
[src/components/Receive.astro](src/components/Receive.astro)

This is the file to look at to understand how to integrate TokenFlight Receive into your own project.
...
astro-native/
  src/
    components/
      Receive.astro         # Core integration — receive widget + AppKit init
      ThemeToggle.astro      # Light/dark theme toggle button
    layouts/Layout.astro     # HTML shell, nav, footer
    pages/index.astro        # Home page (composes Layout + Receive)
